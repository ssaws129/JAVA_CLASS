...
public class _01_DownCasting {
	...
	public static void main(String[] args) {
		...
		Bike b = new FourWheelBike("형준"); //addWheel 기능 사용불가 //부모 클래스의 기능만 사용가능하기 때문
		
		b.bikeInfo();
		b.ride();
//		b.addWheel(); //(예)
		//b는 FourWheelBike 객체를 가리키고 있지만, 부모 클래스로 타입이 되었기 대문에 FourWheelBike의 기능인
		//addWheel기능 사용할 수 없다.
		
		FourWheelBike fwb = (FourWheelBike)b; //강제형변환
		// 다시 자식 클래스 고유의 기능인 addWheel을 사용하고 싶을 때 다운캐스팅한다.
		fwb.addWheel();
		fwb.bikeInfo();
		fwb.ride();
		 ...
		 * 2. 다운캐스팅 해야 자식 클래스의 기능을 다시 사용 가능 (강제형변환)
		 */
